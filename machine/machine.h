...
{
	int					op;
	void				(*func)(int argvs[MAX_ARGS_NUMBER], t_machine *, t_forks *);
}						t_opfunc;

#endif

void					op_add(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_aff(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_and(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_fork(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_ld(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_ldi(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_lfork(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_live(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_lld(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_lldi(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_or(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_st(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_sti(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_sub(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_xor(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
void					op_zjmp(int args[MAX_ARGS_NUMBER], t_machine *d, t_forks *player);
